...
def generate_caption(detail, shopee, lazada, promo, highlights):
    ...
    prompt = (
        ...
        f"✅ ดี: [สรุปจุดดีเด่นๆ ของสินค้า 2-3 บรรทัดสั้นๆ แนะนำแบบผู้หญิงๆ น่ารักๆ ลงท้าย ค่ะ/คะ]\n"
        f"⚠️ ข้อเสีย: [สรุปข้อควรระวังหรือข้อเสียอย่างจริงใจ 1-2 บรรทัด มีคำลงท้าย ค่ะ/คะ]\n"
        f"💡 คุ้มไหม: [สรุปสั้นๆ ว่าคุ้มค่าเหมาะกับใคร ลงท้าย ค่ะ/คะ]\n\n"
