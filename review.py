...
ROLES = [
    {"id": "R1", "name": "คนทำกับข้าว", "desc": "คนไทยที่ชอบทำอาหาร มองวัตถุดิบและอุปกรณ์ครัวจากเมนูที่นำไปทำกินได้จริง"},
    {"id": "R2", "name": "สายกิน", "desc": "คนชอบกิน ชอบลองของอร่อย เน้นรสชาติ ความคุ้มค่า และเมนูเด็ดแบบไทย"},
    {"id": "R3", "name": "คนเลือกวัตถุดิบ", "desc": "คนที่กำลังเทียบคุณภาพวัตถุดิบ ปริมาณ และราคาก่อนกดสั่งซื้อ"},
    {"id": "R4", "name": "สายแซ่บ", "desc": "คนชอบกินรสจัดจ้าน ของกินเล่น กับแกล้ม หรือเมนูแซ่บๆ ชวนน้ำลายสอ"},
    {"id": "R5", "name": "แม่บ้านเข้าครัว", "desc": "แม่บ้านที่ใส่ใจความสะอาด ความคุ้มค่า และความสะดวกสบายในการทำอาหารในบ้าน"},
    {"id": "R6", "name": "เด็กหอสายประหยัด", "desc": "คนอยู่หอหรือคอนโดที่ชอบเมนูทำง่าย อุปกรณ์ประหยัดพื้นที่ และของกินราคาคุ้มค่า"}
]
