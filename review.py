...
def generate_caption(detail, shopee, lazada, promo, highlights):
    ...
    if API_ENABLED:
        prompt = (
            ...
            f"ห้ามขึ้นต้นด้วยวลีสูตร เช่น 'สวัสดีค่ะ', 'วันนี้มีสินค้า', 'ในยุคที่...', 'ปัจจุบัน...' ให้เปิดด้วยความตึงเครียด ความแปลกใจ หรือประโยชน์รูปธรรมตรงๆ ใส่ความเห็นส่วนตัวอย่างน้อย 1 ประโยค ห้ามทุกประโยคมีโครงสร้างหรือจังหวะสมมาตร\n"
