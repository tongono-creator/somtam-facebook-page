...
PAGE_CONFIGS = {
    "chowchow": {
        ...
        "fallbacks": [
            "โฮ่ง! ขอบคุณที่แวะมาคอมเมนต์ครับโฮ่ง 🐶",
            "ขอบคุณที่เอ็นดูพวกเราครับโฮ่ง",
    ...
    "kram": {
        ...
        "fallbacks": [
            "ขอบคุณที่แวะมาคอมเมนต์ครับพี่ 🙏",
            "ขอบคุณที่มาแชร์มุมมองกันครับ",
            "ขอบคุณครับพี่ ไว้มาร่วมกรามค้างกันอีกนะ"
        ]
    },
    "somtam": {
        "name": "พริก 10 เม็ด",
        ...
        "fallbacks": [
            "ขอบคุณที่แวะมาคอมเมนต์นะคะ 🙏",
            "ขอบคุณค่ะ ไว้มาคุยเรื่องของแซ่บกันอีกน้า",
            "ขอบคุณที่มาคอมเมนต์คุยกันนะคะ"
        ]
    },
    "rocket": {
        "name": "Rocket21",
        ...
        "fallbacks": [
            "ขอบคุณที่แวะมาคอมเมนต์ครับพี่ 🙏",
            "ขอบคุณที่มาแชร์มุมมองกันครับ",
            "ขอบคุณครับ ไว้มาดูเรื่องต่อไปกันนะครับ"
        ]
    },
    "default": {
        "name": "แอดมินเพจ",
    ...
    for model_idx, model in enumerate(TEXT_MODELS):
        ...
        try:
            ...
            if result.upper().startswith("SKIP"):
                # ตอบไม่ได้ตรงประเด็น → ขอบคุณสั้นๆ แทนการเงียบ (คำสั่ง Tong 2026-07-20)
                print("[Reply] AI skipped -> thank-you fallback")
                return random.choice(cfg["fallbacks"])
            if result:
                return result
        except Exception as e:
