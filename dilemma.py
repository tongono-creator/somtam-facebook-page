...
def generate_food_dilemma(title="", body="", subreddit="food"):
    angles = [
        "มุมมองที่ 1: ดราม่าร้านอาหาร & ข้อพิพาทโต๊ะอาหาร (สั่งพิเศษแต่ได้ปกติ / บุฟเฟต์ / ลูกค้า vs ร้าน)",
        "มุมมองที่ 2: บทเรียนราคาแพงสายกิน (The Cost of Cheap — ซื้อของกินหรือเครื่องครัวถูกจนท้องเสียหรือพัง)",
        "มุมมองที่ 3: Showdown เทียบถูก vs แพง (ของแพงคุ้มจริงหรือแค่การตลาด / อุปกรณ์ครัวตัวไหนคุ้มค่าสุด)"
    ]
    ...
    prompt = (
        ...
        "กฎเหล็กสำคัญที่สุด:\n"
        "1. วางตัวเป็นบุคคลที่สาม (3rd-party observer) ที่ไปเจอเรื่องนี้มาเล่าต่อ เช่น 'ลูกค้าคนหนึ่ง...', 'ร้านอาหารแห่งหนึ่ง...', 'คนรักการทำอาหารคนหนึ่ง...'\n"
        ...
        '  "seed_comment": "ความคิดเห็นของแอดมินสาวตัวมัม (ลงท้ายค่ะ) ที่เลือกข้างชัดเจนข้างใดข้างหนึ่งทันทีแบบไม่มีกั๊กเพื่อจุดชนวนให้คนเถียง พร้อมหยอดทริคทางออกในครัว และลงท้ายด้วย \'2/2\'"\n'
        "}"
    )
    ...
    if not line1 or not caption or not seed_comment or not contains_thai(line1) or not contains_thai(caption):
        ...
        fallbacks = [
            {
                "line1": "กระทะร้อยเก้าเก้า",
                "line2": "สารเคลือบลอกไว?",
                "caption": "ไปเจอบทเรียนสายประหยัดมาค่ะ คนรักการทำอาหารคนหนึ่งซื้อกระทะเคลือบถูกๆ ร้อยกว่าบาทมาใช้ ปรากฏว่าผัดไปไม่กี่อาทิตย์ สารเคลือบดำๆ ลอกหลุดปนกับข้าว จนเกือบได้ไปคุยกับรากมะม่วง ถ้าเป็นสายเข้าครัวคิดว่าซื้อกระทะถูกแล้วเปลี่ยนบ่อยๆ หรือยอมลงทุนกระทะสเตนเลสเกรดดีตัวจบไปเลยดีคะ? 1/2",
                "seed_comment": "เรื่องของกินเข้าปากอย่าหาประหยัดผิดจุดค่ะ กระทะสเตนเลสเกรดดีๆ ตัวเดียวใช้ยันรุ่นลูก ล้างง่าย ไร้สารพิษ จบปัญหาแน่นอนค่ะ 2/2"
            },
            {
                "line1": "กะเพราหมูกรอบ",
                "line2": "ขอลีนๆ ไร้มัน?",
            ...
            {
                "line1": "กล่องถนอมอาหาร",
                "line2": "ธรรมดา vs สุญญากาศ?",
                "caption": "มีคนมาแชร์ทริคตู้เย็นคลีนค่ะ ซื้อผักและเนื้อสัตว์มาตุนไว้ แต่ใส่ถุงพลาสติกธรรมดา 3 วันก็เน่าทิ้งเสียดายเงิน พอเปลี่ยนมาใช้กล่องสุญญากาศช่วยยืดอายุได้เป็นเดือน ถ้าเป็นลูกเพจคิดว่าการลงทุนซื้อกล่องถนอมอาหารดีๆ คุ้มค่าไหม หรือซื้อพอดีกินวันต่อวันดีคะ? 1/2",
                "seed_comment": "ลงทุนกล่องสุญญากาศดีๆ เถอะค่ะ ประหยัดค่าผักเน่าทิ้งไปได้เดือนละหลายร้อย ตู้เย็นไม่เหม็นอับด้วย ชีเสิร์ฟสุดๆ 2/2"
            }
        ]
